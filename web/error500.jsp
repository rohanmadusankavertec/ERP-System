<%-- 
    Document   : error403
    Created on : Mar 25, 2016, 5:16:40 PM
    Author     : User
--%>
                ...
                <div class="col-md-12">
                    <div class="col-middle">
                        <div class="text-center">
                            ...
                            <p>We track these errors automatically, but if the problem persists feel free to contact us. In the meantime, try refreshing.</p> <h2><a href="index.jsp" class="btn btn-info" role="button">Back TO Dashboard</a></h2>
