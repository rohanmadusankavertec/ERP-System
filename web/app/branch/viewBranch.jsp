...
<%if (ca.checkUserAuth("UPDATE_BRANCH", group) != null) {%>
                    ...
                    <form action="" method="post" class="form-horizontal form-label-left" novalidate>
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="number" id="branchId" class="form-control col-md-7 col-xs-12" name="branchId" value="<%=branch.getBranchId()%>" readonly/>
                            </div>
                        </div>
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" id="branchName" class="form-control col-md-7 col-xs-12"  data-validate-words="1" name="branchName" required="required" value="<%=branch.getBranchName()%>" />
                            </div>
                        </div>
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" id="contactNo" class="form-control col-md-7 col-xs-12"  data-validate-words="1" name="contactNo"  required="required" value="<%=branch.getContactNo()%>" />
                            </div>
                        </div>
                        <div class="item form-group">
                            <label for="Privilege" class="control-label col-md-3 col-sm-3 col-xs-12">Address</label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <textarea rows="4" cols="50" class="form-control col-md-7 col-xs-12" name="address" id="address"><%=branch.getAddress()%></textarea>                
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-4 col-lg-offset-4">
                                ...
                                <button id="send" type="button" class="btn btn-success" onclick="updateSelectedBranch();">Submit</button>
                            </div>
                        </div>
                    </form>
