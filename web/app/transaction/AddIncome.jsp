            ...
            xmlHttp.onreadystatechange = function ()
            {
                if (xmlHttp.readyState === 4 && xmlHttp.status === 200)
                {
                    ...
                    if (reply === "Success") {
                        ...
                        setTimeout("location.href = 'Income?action=loadIncomePage';", 1500);
                    } else {
                        sm_warning("Income is Not Added, Please Try again");
                    }
                }
            };
            xmlHttp.open("POST", "Income?action=saveIncome&account=" + acc + "&amount=" + amt + "&descrip=" + desc + "&acc=" + pacc , true);
            xmlHttp.send();
        }
    }
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="x_content">
                    ...
                    <form action="#" method="post" onsubmit="validate()" class="form-horizontal form-label-left" novalidate>

                        </p>
                        <span class="section">Income Info</span>
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-3">
                                ...
                                <button id="send" type="button" onclick="SaveIncome()" class="btn btn-success">Submit</button>
                            </div>
                        </div>
                        <div class="ln_solid"></div>
