...
<%
    ...
    List<Account> dep = (List<Account>) request.getAttribute("dep");
%>
...
<script type="text/javascript">
    ...
    function SavePurchase() {
        ...
        var proacc = document.getElementById("accountName").value;
        ...
        if (acc === "") {
            sm_warning("Please Select Purchasing Account......");
        } else if (price === "") {
            ...
            xmlHttp.onreadystatechange = function ()
            {
                if (xmlHttp.readyState === 4 && xmlHttp.status === 200)
                {
                    ...
                    if (reply === "Success") {
                        ...
                        setTimeout("location.href = 'FixedAsset?action=ViewPurchase';", 1500);
                    } else {
                        sm_warning("Purchase is Not Added, Please Try again");
                    }
                }
            };
            xmlHttp.open("POST", "FixedAsset?action=SavePurchase&acc=" + acc + "&price=" + price + "&desc=" + desc + "&pacc=" + pacc + "&tdis=" + tdis + "&pamount=" + pamount + "&balance=" + balance + "&cdtype=" + cdtype + "&cdacc=" + cdacc + "&rate=" + rate + "&term=" + term+ "&proacc=" + proacc + "&depacc=" + depacc, true);
            xmlHttp.send();
        }
    }
</script>
            ...
            <div class="x_panel">
                ...
                <div class="x_content">
                    <form action="#" method="post" class="form-horizontal form-label-left" novalidate>
                        <p>
                            <span class="section">Purchasing Info</span> </p>
                        <div class="item form-group">
                            <label for="password2" class="control-label col-md-3 col-sm-3 col-xs-12">Debit Account</label>
                        ...
                        <div class="item form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="email">Depreciation Rate (%)
                            </label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input onkeyup="setPaidAmount()" type="number" id="rate" required="required" class="form-control col-md-7 col-xs-12">
                            </div>
                        </div>
                        <div class="item form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="email">Depreciation term (Years)
                            </label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input onkeyup="setPaidAmount()" type="number" id="term" required="required" class="form-control col-md-7 col-xs-12">
                            </div>
                        </div>
                        <div class="item form-group">
                        ...
                        <div class="clearfix"></div>
                                ...
                                <div class="clearfix"></div>
                        <div id="debtordv" style="padding-top: 20px; padding-bottom: 20px;">
                            <label for="password2" class="control-label col-md-3 col-sm-3 col-xs-12">Depreciation Account</label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <select class="form-control" name="depacc" id="depacc"  required="required" >
                                    <option selected="true" disabled="true" value="">Select Depreciation Account</option>
                                    <%
                                        for (Account ac : dep) {
                                    %>
                                    <option value="<%=ac.getId()%>"><%= ac.getName()%></option>
