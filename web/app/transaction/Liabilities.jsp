...
//    }
    ...
    function SaveLiability() {
        ...
        if (acc === "") {
            sm_warning("Please Select Liability Account......");
        } else if (pacc === "") {
            ...
            xmlHttp.onreadystatechange = function ()
            {
                if (xmlHttp.readyState === 4 && xmlHttp.status === 200)
                {
                    ...
                    if (reply === "Success") {
                        ...
                        setTimeout("location.href = 'Liability?action=ViewLiability';", 1500);
                    } else {
                        sm_warning("Libility is Not Added, Please Try again");
                    }
                }
            };
            xmlHttp.open("POST", "Liability?action=SaveLiability&acc=" + acc + "&pacc=" + pacc + "&itype=" + itype + "&iterm=" + iterm + "&interest=" + interest + "&terms=" + terms + "&amount=" + amount+ "&tpayable=" + tpayable+ "&mpayable=" + mpayable+ "&desc=" + desc, true);
            xmlHttp.send();
        }
    }
            ...
            <div class="x_panel">
                ...
                <div class="x_content">
                    <form action="#" method="post" class="form-horizontal form-label-left" novalidate>
                        <p>
                            <span class="section">Liability Info</span> </p>
                        ...
                        <div class="item form-group">
                            <label for="password2" class="control-label col-md-3 col-sm-3 col-xs-12">Receive Type</label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
