...
<script type="text/javascript">
    ...
    //Calculate Monthlu payable and total Payable
    ...
    var interest = 0;
    var terms = 0;
    //round float value to two decimal values
...
<div class="">
    ...
    <div class="row">
        <%
            List<StaffLoan> bList = (List<StaffLoan>) request.getAttribute("loan");
        %>
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    <h2>Current Loans <small>up to now</small></h2>
                    <ul class="nav navbar-right panel_toolbox">
                        <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                        </li>
                        <li><a class="close-link"><i class="fa fa-close"></i></a>
                        ...
                        <table id="example" class="table table-striped responsive-utilities jambo_table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><%=l.getBalance()%></td>
                                    <td class="last">
                                        <form action="Salary?action=viewUpdateLoan" method="post">
