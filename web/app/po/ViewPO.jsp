...
<script type="text/javascript">
    //get PO item to second table according to po id
    function getItem(id) {
        ...
        xmlHttp.open("POST", "PO?action=GetItems&id=" + id, true);
        xmlHttp.send();
    }
                                    ...
                                    <div class="x_content">
                                        ...
                                        <div class="table-responsive">
                                            ...
                                            Company company = (Company) httpSession.getAttribute("company");
                                                        String hql = "SELECT pi.po_info_id,s.company_name,pi.date,pi.total,su.first_name,su.last_name,pi.status,pi.received_date FROM po_info pi inner join supplier s on s.supplier_id=pi.supplier_supplier_id inner join sys_user su on pi.sys_user_sysuser_id=su.sysuser_id WHERE pi.company_id='"+company.getId()+"'";

                                                        String type = request.getAttribute("type").toString();
                                                        if (type.equals("2")) {
                                                            String sup = request.getAttribute("supId").toString();

                                                            hql += " and pi.supplier_supplier_id ='" + sup + "' ";
