                    ...
                    <form action="" method="post" class="form-horizontal form-label-left" novalidate>
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="number" id="pcId" class="form-control col-md-7 col-xs-12" name="pcId" value="<%=pc.getProductCategoryId()%>" readonly/>
                            </div>
                        </div>
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" id="pcName" class="form-control col-md-7 col-xs-12"  data-validate-words="1" name="pcName" required="required" value="<%=pc.getProductCategoryName()%>" />
                            </div>
                        </div>
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <textarea rows="4" cols="50" class="form-control col-md-7 col-xs-12" name="description" id="description"><%=pc.getDescription()%></textarea>                
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-4 col-lg-offset-4">
                                ...
                                <button id="send" type="button" class="btn btn-success" onclick="updateSelectedPC();">Submit</button>
                            </div>
                        </div>
                    </form>
