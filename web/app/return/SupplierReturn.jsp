...
<script type="text/javascript">
    //load invoice item to  select element
...
//    remove product from first table
    ...
    function submitSupplierReturn() {
        ...
        if (supplierId === "") {
            ...
            nom_warning("Please items received by supplier");
        } else {
            var data = {};
                            ...
                            xmlHttp.onreadystatechange = function ()
                            {
                                if (xmlHttp.readyState === 4 && xmlHttp.status === 200)
                                {
                                    ...
                                    if (reply === "Success") {
                                        ...
                                        setTimeout("location.href = 'Return?action=SupplierReturn';", 1500);
                                    } else {
                                        sm_warning("Supplier Return Not Correctly Entered. Please Try Again.");
                                    }
                                }
                            };
                            xmlHttp.open("POST", "Return?action=SubmitSupplierReturn&data=" + jsonDetails, true);
                            xmlHttp.send();
                        }
                    }, {
                        label: 'No',
...
<div class="">
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    <h2>Add Supplier Return<small></small></h2>
                ...
                <div class="x_content">
                    ...
                    <form method="post" class="form-horizontal form-label-left" novalidate>
                        <div class="item form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Received Item <span class="required"></span>
                            </label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-4 col-lg-offset-4">
                                <button id="send" type="button" class="btn btn-success" onclick="submitSupplierReturn()">Submit</button>
                            </div>
                        </div>
                    </form>
