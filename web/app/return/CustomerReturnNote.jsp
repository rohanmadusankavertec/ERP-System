...
<script type="text/javascript">
    // load invoice product to select element
                            ...
                            xmlHttp.onreadystatechange = function ()
                            {
                                if (xmlHttp.readyState === 4 && xmlHttp.status === 200)
                                {
                                    ...
                                    if (reply === "Success") {
                                        ...
                                        setTimeout("location.href = 'Return?action=PrintCustomerReturnNote';", 1000);
                                    } else {
                                        sm_warning("Credit Note Not Correctly Entered. Please Try Again.");
                                    }
                                }
                            };
                            xmlHttp.open("POST", "Return?action=SubmitCustomerReturnNote&data=" + jsonDetails, true);
                            xmlHttp.send();
                        }
                    }, {
                        label: 'No',
...
<div class="">
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    <h2>Add Customer Return Note<small></small></h2>
