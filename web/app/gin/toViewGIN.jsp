...
<script type="text/javascript">
    ...
    function SentData() {
        ...
        if (type === "1") {
            window.location = "../../GIN?action=viewGIN&type=" + type + "&from=" + fromDate + "&to=" + toDate;
        } else if (type === "3") {
            if (fromDate !== "" && toDate !== "") {
                window.location = "../../GIN?action=viewGIN&type=" + type + "&from=" + fromDate + "&to=" + toDate;
            } else {
                ...
                <div class="x_content">
                    ...
                    <div class="item form-group" style="padding-top: 50px;">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <select class="form-control" name="reportType" id="reportType"   onchange="ChangeFilter()">
                                ...
                                <option value="4">Daily GIN</option>
                            </select>                              
                        </div>
                    </div>
                    <div class="clearfix"></div>
                    ...
                    <div class="item form-group" style="padding-top: 50px;">
                        <div class="col-xs-12 col-lg-offset-3">
                            ...
                            <button class="btn btn-success" onclick="SentData();">View GIN</button>
                        </div>
                    </div>
                    <!--</form>-->
                </div>
