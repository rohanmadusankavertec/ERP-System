...
<script type="text/javascript">
    //get GIN items to second table using gin id
    function getItem(id) {
                                            ...
                                            <table id="example" class="table table-striped responsive-utilities jambo_table">
                                                ...
                                                <tbody>
                                                    ...
                                                    <%
                                                        ...
                                                        String hql = "SELECT gi.id,gi.date,gi.total,su.first_name,su.last_name FROM gin_info gi inner join sys_user su on gi.sysuser_id=su.sysuser_id WHERE gi.company_id='"+company.getId()+"'";
