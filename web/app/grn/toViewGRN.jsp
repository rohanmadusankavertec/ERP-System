...
<script type="text/javascript">
    ...
    //send filter type to serverside
    function SentData(){
        ...
        if(type === "1"){
            window.location = '../../GRN?action=viewGRN&supplier='+sup+"&type="+type+"&from="+fromDate+"&to="+toDate;
        }else if(type ==="2") {
            if(sup !== ""){
                window.location = '../../GRN?action=viewGRN&supplier='+sup+"&type="+type+"&from="+fromDate+"&to="+toDate;
            }else{
                    ...
                    <!--<form action="#" method="post">-->
                            ...
                            <div class="item form-group" style="padding-top: 50px;">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <select class="form-control" name="reportType" id="reportType"   onchange="ChangeFilter()">
                                        ...
                                        <option value="4">Daily GRN</option>
                        ...
                        <div class="clearfix"></div>
                            <div class="hidden" style="padding-top: 50px;" id="supl">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <select class="form-control" name="supplier" id="supplier"  onchange="ChangeFilter()">
...
<div class="clearfix"></div>
                        <div class="item form-group" style="padding-top: 50px;">
                            <div class="col-xs-12 col-lg-offset-3">
                                ...
                                <button class="btn btn-success" onclick="SentData();">View GRN</button>
                            </div>
                        </div>
                    <!--</form>-->
                </div>
