...
<script src="app/js/mrn.js"></script>
                    ...
                    <section class="content invoice">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 col-md-offset-6" style="margin-top: 10px; margin-left: 80%;">
                                <button id="send" onclick="AddToMRN()" class="btn btn-success">Add Item</button>
                            </div>
                        ...
                        <div class="row no-print">
                            <div class="col-xs-12">
                                <button class="btn btn-success pull-right" onclick="submitMRN();"><i class="fa fa-credit-card"></i> Submit Material Requisition Note</button>
                            </div>
                        </div>
                    </section>
