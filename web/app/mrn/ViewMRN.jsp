...
//    view MRN items according to MRN id
    function getItem(id) {
        ...
        xmlHttp.open("POST", "MRN?action=GetItems&id=" + id, true);
        xmlHttp.send();
    }
                    ...
                    <section class="content invoice">
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    <div class="x_title">
                                        <h2>View MRN <small>up to now</small></h2>
                                        <ul class="nav navbar-right panel_toolbox">
                                            <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                                            </li>
                                            <li><a class="close-link"><i class="fa fa-close"></i></a>
                                    ...
                                    <div class="x_content">
                                        <div class="table-responsive">
                                            ...
                                            Company company = (Company) httpSession.getAttribute("company");
                                                        ...
                                                        String hql = "SELECT mi.id,mi.date,su.first_name,su.last_name FROM mrn_info mi inner join sys_user su on mi.sysuser_id=su.sysuser_id WHERE mi.company_id='"+company.getId()+"'";
                                                    ...
                                                    <tr onclick="getItem(<%= list[0].toString()%>)">
                                                        ...
                                                        <td><%= list[2].toString()%> <%= list[3].toString()%></td>
