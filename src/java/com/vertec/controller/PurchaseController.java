...
public class PurchaseController extends HttpServlet {
     ...
     */
    private final PurchaseDAOImpl purchaseDAOImpl = new PurchaseDAOImpl();
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            switch (action) {
                ...
                case "ViewPurchase": {
                    ...
                    List<Account> acList1 = purchaseDAOImpl.loadCreditorAccounts(company);
                    request.setAttribute("creditor", acList1);
                    List<Account> acList2 = purchaseDAOImpl.loadDebtorAccounts(company);
                    request.setAttribute("debtor", acList2);
                    requestDispatcher = request.getRequestDispatcher("app/transaction/Purchase.jsp");
                ...
                case "SavePurchase": {
                    ...
                    if (cdtype.equals("creditor")) {
                        ...
                        tr1.setPrice(cd);
                        Result2 = saveDAOImpl.saveObject(tr1);
                        ...
                        tr2.setPrice(cd);
                        Result2 = saveDAOImpl.saveObject(tr2);
                    }
