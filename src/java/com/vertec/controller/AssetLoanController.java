...
import com.vertec.daoimpl.AssetLoanDAOImpl;
 ...
 * @author vertec-r
 */
@WebServlet(name = "AssetLoanController", urlPatterns = {"/AssetLoanController"})
public class AssetLoanController extends HttpServlet {
     ...
     */
    private final AssetLoanDAOImpl assetloanDAOImpl = new AssetLoanDAOImpl();
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            switch (action) {
                ...
                case "getAccountBysubtype": {
                    ...
                    List<Account> prList = assetloanDAOImpl.loadAccountsBySubtype(company, stype);
                ...
                case "SaveLoan": {
                    ...
                    loan.setIsLiability(false);
                    loan.setPaid(0.0);
                    loan.setAccountId(new Account(Integer.parseInt(acc)));
