 ...
 */
@WebServlet(name = "DrawingController", urlPatterns = {"/DrawingController"})
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            switch(action){
                ...
                case "loadAccount":{
                    ...
                    requestDispatcher = request.getRequestDispatcher("/app/transaction/AddDrawing.jsp");
                ...
                case "loadAccountByPayName":{
                    ...
                    List<Account> acList = drawingdao.loadAccountByPayName(sName, company);
